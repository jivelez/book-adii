...
## Dedicatoria {-}
Dedicado a Lilyam y Abraham por su apoyo;  a Norma Botero por mostrarme el camino; a mis maestros y amigos, [Mauricio Arcos-Burgos](https://scholar.google.com.co/citations?user=MZlwFqgAAAAJ&hl=en) y [Juan Carlos Correa](http://ciencias.medellin.unal.edu.co/index.php/component/teachers/?escuela=Escuela%20de%20Estad%C3%ADstica&letra=&correo=jccorrea@unal.edu.co)  por sus enseñanzas y acompañamiento; a [Yolima](https://www.instagram.com/yolimaespinosamarykay/?hl=es), por su amor incondicional, su infinita comprensión y paciencia; y a Gabriela, mi *monstruo peludo*, por darme fuerzas cuando no había razones para continuar.

...
### Variaciones
El modelo de Regresión Poisson tiene algunas variaciones. Para mayor información, se sugiere consultar el documento _Regression Models for Count Data in R_ [@count].
